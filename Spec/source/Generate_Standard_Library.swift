...
for type in ["bool", "uchar", "ushort", "uint", "char", "short", "int", "half", "float"] {
    ...
    print("native \(type) operator.x=(\(type)2, \(type));")
    print("native \(type) operator.y=(\(type)2, \(type));")
    print("native \(type) operator.x=(\(type)3, \(type));")
    print("native \(type) operator.y=(\(type)3, \(type));")
    print("native \(type) operator.z=(\(type)3, \(type));")
    print("native \(type) operator.x=(\(type)4, \(type));")
    print("native \(type) operator.y=(\(type)4, \(type));")
    print("native \(type) operator.z=(\(type)4, \(type));")
    print("native \(type) operator.w=(\(type)4, \(type));")
