print(`// This was autogenerated from Generate_Standard_Library.js! Do not edit!!`);
print();

for (let type of [`void`, `bool`, `uint`, `int`, `float`, `atomic_int`, `atomic_uint`]) {
...
for (let type of [`Texture1D`, `RWTexture1D`, `Texture1DArray`, `RWTexture1DArray`, `Texture2D`, `RWTexture2D`, `Texture2DArray`, `RWTexture2DArray`, `Texture3D`, `RWTexture3D`, `TextureCube`]) {
    for (let typeArgumentBase of [`uint`, `int`, `float`]) {
        for (let size of [``, `2`, `3`, `4`]) {
...
for (let type1 of [`uint`, `int`, `float`]) {
    for (let type2 of [`uint`, `int`, `float`]) {
        if (type1 != type2) {
...
for (let type of [`uint`]) {
    for (let size of [2, 3, 4]) {
        print(`uint${size} count_bits(${type}${size} x) {`);
...
for (let type of [`uint4`,`int4`, `float4`]) {
